...
contract Manifester is IManifester {
    ...
    constructor(
        ...
        SoulSwapFactory = ISoulSwapFactory(0x5BB2a9984de4a69c05c996F7EF09597Ac8c9D63a);
        // sets: sacrifice to 5%.
        bloodSacrifice = toWei(5);
        nativeSymbol = "NATIVE";
        // sets: key addresses.
        auraAddress = 0x268D3D63088821C17c59860D6B9476680a4843d2;
        usdcAddress = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
        wnativeAddress = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
        soulDAO = msg.sender;

        // creates: the first Enchanter[0].
        addEnchanter(0xFd63Bf84471Bc55DD9A83fdFA293CCBD27e1F4C8);
    }
