...
deploy-sepolia :; @forge script script/${contract}.s.sol:Deploy${contract} --rpc-url ${AVAX_RPC_URL}  --private-key ${PK} --broadcast --verify --etherscan-api-key ${AVAXSCAN_API_KEY}  -vvvv
